...
- Option to pick letters, numbers, and symbols. This also includes a slider to choose the length
- A new label appears clicking to generate the password and its error messages

## Code Used
- Function: boolean & conditions
- Random
- String
